...
class tx_rx_ofdm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "tx_rx_ofdm")
        ...
        self.central_freq = central_freq = 500000000

        ##################################################
        # Blocks
        ##################################################
        self.uhd_usrp_source_0 = uhd.usrp_source(
            ",".join(("addr=192.168.1.6", "send_frame_size=8192,recv_frame_size=8192")),
            uhd.stream_args(
                cpu_format="fc32",
                args='',
        ...
        self.qtgui_const_sink_x_0_0.set_y_axis((-30), 30)
        ...
        self.fft_vxx_2 = fft.fft_vcc(fft_len, False, (), True, 1)
        ...
        self.digital_header_payload_demux_0 = digital.header_payload_demux(
            ...
            (),
            0)
        self.digital_crc32_bb_1 = digital.crc32_bb(False, packet_length_tag_key, True)
        ...
        self.blocks_file_sink_0_0_1 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\burke\\OneDrive\\Desktop\\Uni\\4E2\\data_tx_crc.txt', False)
        ...
        self.blocks_file_sink_0_0_0_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'C:\\Users\\burke\\OneDrive\\Desktop\\Uni\\4E2\\tx_frames.txt', False)
        ...
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\burke\\OneDrive\\Desktop\\Uni\\4E2\\data_tx_packed.txt', False)
        self.blocks_file_sink_0_0_0.set_unbuffered(False)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\burke\\OneDrive\\Desktop\\Uni\\4E2\\data_tx.txt', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\burke\\OneDrive\\Desktop\\Uni\\4E2\\data_rx.txt', False)
        ...
        self.connect((self.digital_protocol_formatter_bb_0, 0), (self.blocks_repack_bits_bb_1_0, 0))
        ...
        self.connect((self.fft_vxx_2, 0), (self.digital_ofdm_cyclic_prefixer_0, 0))
    ...
    def set_central_freq(self, central_freq):
        ...
        self.uhd_usrp_sink_1.set_center_freq(self.central_freq, 0)
