...
class OTFS(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\burke\\OneDrive\\Desktop\\Test_Output.txt', False)
        ...
        self.connect((self.digital_qam_mod_0, 0), (self.qtgui_freq_sink_x_2, 0))
        self.connect((self.digital_qam_mod_0, 0), (self.qtgui_time_sink_x_1, 0))
