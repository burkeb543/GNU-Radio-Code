...
class BER_Test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\burke\\OneDrive\\Desktop\\input_seq.txt', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\burke\\OneDrive\\Desktop\\output_seq.txt', False)
        ...
        self.connect((self.digital_gmsk_demod_0, 0), (self.fec_ber_bf_0, 1))
        self.connect((self.digital_gmsk_mod_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.fec_ber_bf_0, 0), (self.qtgui_sink_x_0, 0))
