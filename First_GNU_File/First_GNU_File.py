...
class First_GNU_File(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "First_GNU_File", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("First_GNU_File")
        ...
        self.settings = Qt.QSettings("GNU Radio", "First_GNU_File")
        ...
        self.len_tag_key = len_tag_key = 50
        ...
        self.connect((self.digital_ofdm_rx_0, 0), (self.blocks_vector_sink_x_0, 0))
...
def main(top_block_cls=First_GNU_File, options=None):
